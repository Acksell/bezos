...
// GenerateSchemaGo generates Go code that embeds and loads schema_dynamodb.yaml.
// The generated code exports a Schema variable that can be passed to ddbui.NewServer.
func GenerateSchemaGo() ([]byte, error) {
	code := []byte(`// Code generated by ddbgen. DO NOT EDIT.
...
`)
	...
	if err != nil {
		return code, fmt.Errorf("formatting schema go code: %w", err)
	}
