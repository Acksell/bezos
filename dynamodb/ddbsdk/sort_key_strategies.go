...
// SortKeyCondition defines how to filter on the sort key in a range query.
type SortKeyCondition func(skName string) expression2.KeyConditionBuilder

// Equals returns items where the sort key equals the provided value.
func Equals[T any](v T) SortKeyCondition {
...
func Between[T any](start, end T) SortKeyCondition {
	return func(skName string) expression2.KeyConditionBuilder {
...
func GreaterThan[T any](v T) SortKeyCondition {
	return func(skName string) expression2.KeyConditionBuilder {
...
func GreaterThanOrEqual[T any](v T) SortKeyCondition {
	return func(skName string) expression2.KeyConditionBuilder {
...
func LessThan[T any](v T) SortKeyCondition {
	return func(skName string) expression2.KeyConditionBuilder {
...
func LessThanOrEqual[T any](v T) SortKeyCondition {
	return func(skName string) expression2.KeyConditionBuilder {
