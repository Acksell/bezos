...
func NewUnsafePut(table TableDefinition, key table.PrimaryKey, e DynamoEntity) *Put {
	return NewPut(table, key, e)
}

// Put with optimistic locking
func NewSafePut(table TableDefinition, key table.PrimaryKey, e DynamoEntity) *Put {
